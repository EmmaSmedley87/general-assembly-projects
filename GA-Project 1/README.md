...
Ninja Turtles Pac Man is as the title suggests a Ninja Turtles take on the original Pac Man game. The Ninja Turtles are craving pizza as usual, the objective of the game is to munch all of the pizzas on the board, but watch out- Shredder is out to get you as usual!

This was the first project in General Assembly's Software Engineering Immersive course. It was vanilla Javascript game built for the browser, individually with a timeline of 7 days!


## Game Instructions

- Use the arrow keys to move ninja turtle around the grid
- Press an arrow key in the direction you want to move to the start game
...
- Day 6 - MVP achieved
- Day 7 - Resolving final problems and features
...
I created a timeline to ensure i would meet the deadline and achieve my MVP, with some time to spare- to allow for any problems that might arise during the game build. I also clearly distinguished my essential features from my 'nice to have's', so i wouldn't take on more than i could achieve within the timeframe, but had noted some cool features for future improvements.
...
- Get extra life if land on a turtle karate band
...
Shredder predictive movement added and sorted the turtle pizza removal problem when landing on each grid position displaying a pizza. (See wins amd challenges below)
...
Getting the turtle to move in all directions- but not through walls and also getting the pizza to 'disappear' from the screen once the turtle had eaten it- this was actually one of the biggest challenges i overcame during this project.

**Wins**

A big win for me was getting Shredder to not only randomly appear on a square in a shredderPosition, but to predictivly move Shredder nearer to the turtle based on the movements that the player chose for the turtlePosition. I was really happy with this as my MVP was for Shredder to just randomly appear in a different box each time turtle moved.
...
- Noise and catchphrase words added when land on Master Splinter or Shredder
- Chomping noise when turtle 'eats' a pizza


## Key Learnings

The importance of commenting your code when it comes to refactoring or referencing it later in the project. The use of implementing functions and referencing them, instead of creating a new function each time- this helps to keep the code DRY and clean. Using classes when creating a project to enable you to vary what functionality will be applied to each. 
